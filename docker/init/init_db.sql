...
\ c staticpi CREATE TABLE IF NOT EXISTS ip_address (
...
GRANT USAGE,
SELECT
	ON SEQUENCE registered_user_audit_user_audit_id_seq TO staticpi;
...
CREATE TRIGGER registered_user_audit_trig BEFORE
INSERT
	OR
UPDATE
...
GRANT USAGE,
SELECT
	ON SEQUENCE device_audit_device_audit_id_seq TO staticpi;

CREATE FUNCTION device_audit_func() RETURNS TRIGGER AS $ body $ BEGIN IF tg_op = 'UPDATE' THEN
INSERT into
	device_audit (
		table_name,
		user_name,
...
ELSIF tg_op = 'INSERT' THEN
INSERT into
	device_audit (table_name, user_name, action, new_values, query)
VALUES
	(
		tg_table_name :: TEXT,
		current_user,
...
CREATE TRIGGER device_trig BEFORE
INSERT
	OR
UPDATE
	OR DELETE ON device FOR EACH ROW EXECUTE PROCEDURE device_audit_func();
...
GRANT USAGE,
SELECT
	ON SEQUENCE api_key_audit_api_key_audit_id_seq TO staticpi;

CREATE FUNCTION api_key_audit_func() RETURNS TRIGGER AS $ body $ BEGIN IF tg_op = 'UPDATE' THEN
INSERT into
	api_key_audit (
		table_name,
		user_name,
...
ELSIF tg_op = 'INSERT' THEN
INSERT into
	api_key_audit (table_name, user_name, action, new_values, query)
VALUES
	(
		tg_table_name :: TEXT,
		current_user,
...
CREATE TRIGGER api_key_trig BEFORE
INSERT
	OR
UPDATE
	OR DELETE ON api_key FOR EACH ROW EXECUTE PROCEDURE api_key_audit_func();
...
GRANT USAGE,
SELECT
	ON SEQUENCE two_fa_secret_audit_two_fa_secret_audit_id_seq TO staticpi;

CREATE FUNCTION two_fa_secret_audit_func() RETURNS TRIGGER AS $ body $ BEGIN IF tg_op = 'UPDATE' THEN
INSERT into
	two_fa_secret_audit (
		table_name,
		user_name,
...
ELSIF tg_op = 'INSERT' THEN
INSERT into
	two_fa_secret_audit (table_name, user_name, action, new_values, query)
VALUES
	(
		tg_table_name :: TEXT,
		current_user,
...
CREATE TRIGGER two_fa_secret_trig BEFORE
INSERT
	OR
UPDATE
	OR DELETE ON two_fa_secret FOR EACH ROW EXECUTE PROCEDURE two_fa_secret_audit_func();
...
GRANT USAGE,
SELECT
	ON SEQUENCE two_fa_backup_audit_two_fa_backup_audit_id_seq TO staticpi;

CREATE FUNCTION two_fa_backup_audit_func() RETURNS TRIGGER AS $ body $ BEGIN IF tg_op = 'UPDATE' THEN
INSERT into
	two_fa_backup_audit (
		table_name,
		user_name,
...
ELSIF tg_op = 'INSERT' THEN
INSERT into
	two_fa_backup_audit (table_name, user_name, action, new_values, query)
VALUES
	(
		tg_table_name :: TEXT,
		current_user,
...
CREATE TRIGGER two_fa_backup_trig BEFORE
INSERT
	OR
UPDATE
	OR DELETE ON two_fa_backup FOR EACH ROW EXECUTE PROCEDURE two_fa_backup_audit_func();